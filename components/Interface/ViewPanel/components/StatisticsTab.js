app.component('statistics-tab', {
    ...
    <div class="display-system SOON" id="statistics-container">
        ...
        <div class="contribute">
            ...
            <a class="roadmap-button" target="_blank" href="https://github.com/orgs/skyvue-satellite-tracking/projects/1"><img src="./assets/roadmap_github.png" alt="skuVue's roadmap"></a>
        </div>
